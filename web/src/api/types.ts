...
export interface CargoSafetyEvaluationResult { review: CargoSafetyReview; assessment: { result: string; explanation: string; evidence_excerpt: string | null; structured_dangerous_goods: boolean; structured_un_number: string | null; structured_commodity: string; checker_kind: string; model_name: string | null }; policy_result: { disposition: string; automation_blocked: boolean; reason: string }; decision: Decision | null; }
export interface CargoSafetyHistory { review: CargoSafetyReview; assessment: CargoSafetyEvaluationResult["assessment"] | null; policy_result: CargoSafetyEvaluationResult["policy_result"] | null; decision: Decision | null; }
